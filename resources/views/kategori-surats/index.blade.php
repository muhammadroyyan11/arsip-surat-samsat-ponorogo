...
<div class="modal fade" id="modalForm" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="formData" class="ajax-form" action="{{ route('kategori-surats.store') }}" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control" required placeholder="Surat Keputusan, Undangan, dll...">
                    </div>
                </div>
            ...
            <form action="{{ route('kategori-surats.import') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="alert alert-info py-2 small">
                        ...
                        <a href="{{ route('kategori-surats.template') }}" class="alert-link"><i class="fas fa-download"></i> Download Template</a>
                    </div>
                    <div class="mb-3">
...
<script>
    $(document).ready(function() {
        $('#datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('kategori-surats.index') }}",
            columns: [
    ...
    function resetForm() {
        ...
        $('#formData').attr('action', "{{ route('kategori-surats.store') }}");
