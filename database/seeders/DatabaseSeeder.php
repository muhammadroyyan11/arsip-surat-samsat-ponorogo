...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $division = \App\Models\Division::create(['name' => 'Direksi']);
        $position = \App\Models\Position::create(['name' => 'Direktur Utama']);
        ...
        $sectionMaster = \App\Models\MenuSection::create(['section_name' => 'Master Data', 'order' => 1]);
        $sectionMail = \App\Models\MenuSection::create(['section_name' => 'Surat Menyurat', 'order' => 2]);
        $sectionSystem = \App\Models\MenuSection::create(['section_name' => 'System', 'order' => 3]);
        ...
        foreach ($menus as $m) {
            $menu = \App\Models\Menu::create($m);
            \App\Models\UserMenu::create(['user_id' => $user->id, 'menu_id' => $menu->id]);
        }
